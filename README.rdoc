...
To use the Rails 3 compatible version of this plugin, please install it like so:
    ...
    rails plugin install git://github.com/oleksandrbyk/olek-ruby-detecting-mobile.git
...
To use the Rails 2 compatible version of this plugin, please install it like so:
    ...
    script/plugin install git://github.com/oleksandrbyk/olek-ruby-detecting-mobile.git -r 2.x
